...
const ExcelUploadTemplateManage = () => {
    ...
    const initializeTable = async () => {
      ...
      try {
        tableInstance.current = createTable(tableRef.current, [
          ...
          { headerHozAlign: "center", hozAlign: "left", title: "제목", field: "TITLE", sorter: "string", editable: false },
  ...
  const handleSearch = async () => {
    ...
    setIsSearched(true);
    try {
      const params = { pGUBUN: "LIST", pTITLE: filters.searchText || "", pFILEID: "", pDEBUG: "F" };
